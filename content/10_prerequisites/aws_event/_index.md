...
Once you have completed the step above, you can leave the AWS console open. You can now move to the [**Workshop Setup**](/en/10_prerequisites/50_workshop_setup.html) section.
